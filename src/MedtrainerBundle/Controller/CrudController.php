...
namespace MedtrainerBundle\Controller;

use MedtrainerBundle\Entity\Crud;
...
class CrudController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cruds = $em->getRepository('MedtrainerBundle:Crud')->findAll();
    ...
    {
        $crud = new Crud();
        $form = $this->createForm('MedtrainerBundle\Form\CrudType', $crud);
    ...
    {
        $deleteForm = $this->createDeleteForm($crud);
        $editForm = $this->createForm('MedtrainerBundle\Form\CrudType', $crud);
